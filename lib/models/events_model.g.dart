...
const EventSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'remianderTime': PropertySchema(
      id: 2,
      name: r'remianderTime',
      type: IsarType.dateTime,
    ),
...
void _eventSerialize(
  ...
  writer.writeString(offsets[1], object.eventTitle);
  writer.writeDateTime(offsets[2], object.remianderTime);
...
Event _eventDeserialize(
  ...
  final object = Event(
    ...
    eventTitle: reader.readString(offsets[1]),
    id: id,
    remianderTime: reader.readDateTime(offsets[2]),
...
extension EventQueryFilter on QueryBuilder<Event, Event, QFilterCondition> {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> remianderTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'remianderTime',
        value: value,
      ));
    });
  }

  QueryBuilder<Event, Event, QAfterFilterCondition> remianderTimeGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> remianderTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> remianderTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension EventQuerySortBy on QueryBuilder<Event, Event, QSortBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> sortByRemianderTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'remianderTime', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByRemianderTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'remianderTime', Sort.desc);
    });
  }
...
extension EventQuerySortThenBy on QueryBuilder<Event, Event, QSortThenBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> thenByRemianderTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'remianderTime', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByRemianderTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'remianderTime', Sort.desc);
    });
  }
...
extension EventQueryWhereDistinct on QueryBuilder<Event, Event, QDistinct> {
  ...
  QueryBuilder<Event, Event, QDistinct> distinctByRemianderTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'remianderTime');
    });
  }
...
extension EventQueryProperty on QueryBuilder<Event, Event, QQueryProperty> {
  ...
  QueryBuilder<Event, DateTime, QQueryOperations> remianderTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'remianderTime');
    });
  }
