        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: CustomText(text: AppConstants.setDate,fontSize: 18.sp,color: AppColors.black,fontWeight: FontWeight.w700,),
            ),
            Container(
              clipBehavior: Clip.antiAlias,
               height: 360.h,
              ...
              decoration: BoxDecoration(
                color: AppColors.whiteFFFFF,
                boxShadow:  [BoxShadow(color: AppColors.grey787878.withOpacity(0.4),spreadRadius: 0.1,blurRadius: 0.3)],
